...
from src.secrets import resolve_secrets
    ...
    with snowflake.connector.connect(
        ...
        for table_name in tables:
            ...
            mar_record = MARRecord(
                f_number=f_number, api=api, inserted_count=count, updated_count=0, table_name=table_name
            )
...
def construct_create_table_statement_from_pydantic_model(Model: Type[Any], table_name: str, override: bool):
    ...
    create_table_statement = construct_table_schema(
...
async def provision_fnumber_schema(f_number: str, api_name: str, is_hippa: bool):
    ...
    upload_config = UploadConfig(api_name=api_name, f_number=f_number)
